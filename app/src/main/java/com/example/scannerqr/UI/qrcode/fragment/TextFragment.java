...
import com.example.scannerqr.databinding.FragTextBinding;
...
public class TextFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragTextBinding.inflate(inflater,container,false);
        ...
        binding.btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    bitmap = barcodeEncoder.encodeBitmap(binding.edText.getText().toString(), BarcodeFormat.QR_CODE, 500, 500);

...
public class WifiFragment extends Fragment {
    ...
    private FragWifiBinding binding;
    private BarcodeEncoder barcodeEncoder;
    private Bitmap bitmap;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragWifiBinding.inflate(inflater,container,false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String wifi = binding.edName.getText().toString();
                String passType = binding.edType.getText().toString();
                String pass = binding.edPass.getText().toString();
                String wifiData = "WIFI:T:"+ wifi +";S:"+passType + ";P:" +pass;
                try {
                    barcodeEncoder = new BarcodeEncoder();
                    bitmap = barcodeEncoder.encodeBitmap(wifiData, BarcodeFormat.QR_CODE, 500, 500);
